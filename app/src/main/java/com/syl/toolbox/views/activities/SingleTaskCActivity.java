...
public class SingleTaskCActivity extends AppCompatActivity implements View.OnClickListener {

    public static final String TAG = SingleTaskCActivity.class.getSimpleName();
