...
public class SingleTopBActivity extends AppCompatActivity implements View.OnClickListener {

    public static final String TAG = SingleTopBActivity.class.getSimpleName();
