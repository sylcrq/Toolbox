...
public class SingleInstanceBActivity extends AppCompatActivity implements View.OnClickListener {

    public static final String TAG = SingleInstanceBActivity.class.getSimpleName();
