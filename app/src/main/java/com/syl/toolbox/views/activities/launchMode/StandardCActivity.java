...
/**
 * LaunchMode="standard" Activity C
 *
 * Add by syl, 2015/101/15
 */
public class StandardCActivity extends AppCompatActivity {

    public static final String TAG = StandardCActivity.class.getSimpleName();
